...
Remaining households are dealth with by using (household, male, AGE). There is a
sort of painful issue related to this: people are expected to show up for five
quarters, so everyone's age increases by one, and possibly by two.
